<!-- Необходимо создать массив в самом верху php-файла, в котором будет описываться опыт работы (навыки и языки). 
...
$experience = [
    [
        ...
        'start' => 'Jan 2015',
        'finish' => 'Current',
        'comment' => '1 Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
    ...
    [
        ...
        'start' => 'Mar 2012',
        'finish' => 'Dec 2014',
        'comment' => '2 Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
              sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
    ],
    [
        'position' => '3 Graphic Designer',
        'start' => 'Jun 2010',
        'finish' => 'Mar 2012',
        'comment' => '3 Lorem ipsum dolor sit amet, consectetur adipisicing elit.',
    ],
];
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <?php for ($i = 0; $i < count($experience); $i++) { ?>
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]["start"] ?> - <?= $experience[$i]["finish"] ?></h6>
                <p><?= $experience[$i]["comment"] ?></p>
            <hr>
            </div>
